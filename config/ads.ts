...
export const AD_CONFIG = {
  ...
  GOOGLE_ADSENSE: {
    CLIENT_ID: process.env.NEXT_PUBLIC_GOOGLE_ADSENSE_CLIENT || 'ca-pub-xxxxxxxxxxxxxxx',
  ...
  AD_BLOCKER: {
    ...
    MESSAGE_TEXT: 'Please consider disabling your ad blocker to support our free service.',
  },
...
export const AD_PLACEMENTS = {
  HOME: {
    ...
    placements: [
      ...
      { id: 'home-hero-after', position: 'between-content', format: 'rectangle', priority: 2 },
      { id: 'home-features-after', position: 'between-content', format: 'rectangle', priority: 3 },
      { id: 'home-cta-after', position: 'between-content', format: 'rectangle', priority: 4 },
      { id: 'home-bottom', position: 'bottom', format: 'leaderboard', priority: 5 },
    ],
  },
  ...
  DOWNLOADS: {
    enabled: true,
    placements: [
      { id: 'downloads-top', position: 'top', format: 'leaderboard', priority: 1 },
      { id: 'downloads-preview-after', position: 'between-content', format: 'rectangle', priority: 2 },
      { id: 'downloads-features-after', position: 'between-content', format: 'rectangle', priority: 3 },
      { id: 'downloads-requirements-after', position: 'between-content', format: 'rectangle', priority: 4 },
      { id: 'downloads-bottom', position: 'bottom', format: 'leaderboard', priority: 5 },
    ],
  },
  ...
  ABOUT: {
    ...
    placements: [
      ...
      { id: 'about-offer-after', position: 'between-content', format: 'rectangle', priority: 2 },
      { id: 'about-bottom', position: 'bottom', format: 'leaderboard', priority: 3 },
    ],
  },
  ...
  CONTACT: {
    enabled: true,
    placements: [
      { id: 'contact-top', position: 'top', format: 'leaderboard', priority: 1 },
      { id: 'contact-header-after', position: 'between-content', format: 'rectangle', priority: 2 },
      { id: 'contact-info-after', position: 'between-content', format: 'rectangle', priority: 3 },
      { id: 'contact-bottom', position: 'bottom', format: 'leaderboard', priority: 4 },
    ],
  },
} as const;
...
export const AD_NETWORKS = {
  GOOGLE_ADSENSE: {
    ...
    formats: ['leaderboard', 'banner', 'rectangle', 'large-rectangle', 'skyscraper', 'fluid'],
  },
...
export function shouldShowAd(placementId: string, pageType: keyof typeof AD_PLACEMENTS): boolean {
  if (!isAdsEnabled()) return false;

  const pageConfig = AD_PLACEMENTS[pageType];
  if (!pageConfig.enabled) return false;

  return pageConfig.placements.some(placement => placement.id === placementId);
}
...
export const AD_STYLES = {
  CONTAINER: {
    DEFAULT: 'my-4 mx-auto overflow-hidden bg-gray-50 border border-gray-200 rounded-lg',
    MOBILE: 'my-3 mx-2',
    DESKTOP: 'my-6',
  },
  PLACEHOLDER: {
