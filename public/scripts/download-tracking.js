...
(function () {
  ...
  function setupDownloadTracking() {
    ...
    document.addEventListener("click", function (event) {
      ...
      if (downloadButton) {
        const platform =
          downloadButton.getAttribute("data-track-platform") || "unknown";
        const location =
          downloadButton.getAttribute("data-track-location") || "unknown";
    ...
    document.addEventListener(
      ...
      function (event) {
        ...
        if (link) {
          ...
          const eventType = isAppStore
            ? EVENT_TYPES.APP_STORE_REDIRECT
            : EVENT_TYPES.PLAY_STORE_REDIRECT;
          ...
          // Redirect after tracking (small delay to ensure event is sent)
          setTimeout(() => {
