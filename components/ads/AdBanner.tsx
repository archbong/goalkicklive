...
export default function AdBanner({
  ...
  const getContainerClasses = (): string => {
    const baseClasses = `ad-banner ad-banner-${position} ${margin} ${padding} ${className}`;
...
export function BetweenContentAd({ index = 1, ...props }: Omit<AdBannerProps, 'position'> & { index?: number }) {
  return (
    <div className="my-8">
